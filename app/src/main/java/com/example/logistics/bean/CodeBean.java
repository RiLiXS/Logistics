...
public class CodeBean implements Serializable {
    ...
    private List<BarcodeBean> processPriceVos;
    private String saleOrderId;
    private String planNo;
    private String materialsCodeName;
    ...
    public List<BarcodeBean> getProcessPriceVos() {
        return processPriceVos;
    }

    public void setProcessPriceVos(List<BarcodeBean> processPriceVos) {
    ...
    public String getMaterialsCodeName() {
        return materialsCodeName;
    }

    public void setMaterialsCodeName(String materialsCodeName) {
        this.materialsCodeName = materialsCodeName;
    }
