 ...
 * @date :15.3.22
 */
public class RequestWorkCenterBean implements Serializable {
    ...
    private String publicQty;
    private String materialQty;
    private String minimumPieces;
    private String minimumPiecesBad;
    ...
    private List<WorkCenterBadItemListBean> workCenterBadItemList;
    ...
    public String getPublicQty() {
        return publicQty;
    }

    public void setPublicQty(String publicQty) {
    ...
    public String getMinimumPiecesBad() {
        return minimumPiecesBad;
    }

    public void setMinimumPiecesBad(String minimumPiecesBad) {
    ...
    public List<WorkCenterBadItemListBean> getWorkCenterBadItemList() {
        return workCenterBadItemList;
    }

    public void setWorkCenterBadItemList(List<WorkCenterBadItemListBean> workCenterBadItemList) {
