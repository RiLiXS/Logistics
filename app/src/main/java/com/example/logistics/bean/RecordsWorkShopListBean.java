 ...
 * @date :12.2.22
 */
public class RecordsWorkShopListBean implements Serializable {
    ...
    private String planScheduleIds;
    ...
    public String getWorkCenterList() {
        return workCenterList;
    }

    public void setWorkCenterList(String workCenterList) {
    ...
    public String getPlanScheduleIds() {
        return planScheduleIds;
    }

    public void setPlanScheduleIds(String planScheduleIds) {
        this.planScheduleIds = planScheduleIds;
    }
}
