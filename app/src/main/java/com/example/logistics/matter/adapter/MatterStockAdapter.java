...
/**
 * @author : jyx
 * @description: 入库管理adapter
 * @date :27.9.21
 */
public class MatterStockAdapter extends RecyclerView.Adapter<MatterStockAdapter.BaseViewHolder> {
    private List<HomeFunctionBean> mData;
    private Context context;

    public MatterStockAdapter(Context context) {
