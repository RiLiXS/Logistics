package com.example.logistics.matter;
...
/**
 * @author : jyx
 * @description: 生产领料料adapter
 * @date :27.9.21
 */
public class MatterProductAdapter extends RecyclerView.Adapter<MatterProductAdapter.BaseViewHolder> {
    private List<HomeFunctionBean> mData;
    private Context context;

    public MatterProductAdapter(Context context) {
        this.context = context;
    }

    @Override
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_matter_product_list, parent, false);
