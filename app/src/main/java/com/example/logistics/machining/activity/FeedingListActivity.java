 ...
 * 投料列表
 */
public class FeedingListActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected int initLayout() {
        return R.layout.activity_feeding_list;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_add://新增投料
                startActivity(new Intent(this, FeedingAddActivity.class));
                break;
