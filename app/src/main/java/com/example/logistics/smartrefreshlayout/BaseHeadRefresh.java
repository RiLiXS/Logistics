...
/**
 * @author : jyx
 * @description: 通用基类header
 * @date :12/24/20
 */
public class BaseHeadRefresh extends InternalAbstract implements RefreshHeader {
    ...
    public BaseHeadRefresh(Context context) {
        this(context, null);
    }

    public BaseHeadRefresh(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaseHeadRefresh(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        View view = LayoutInflater.from(context).inflate(R.layout.base_head, this);
