...
/**
 * @author : jyx
 * @description: 首检任务adapter
 * @date :27.9.21
 */
public class FirstListTaskAdapter extends RecyclerView.Adapter<FirstListTaskAdapter.BaseViewHolder> {
    private List<HomeFunctionBean> mData;
    private Context context;

    public FirstListTaskAdapter(Context context) {
        this.context = context;
    }

    @Override
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_first_task_list, parent, false);
