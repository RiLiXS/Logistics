...
/**
 * @author : jyx
 * @description: 巡检任务adapter
 * @date :27.9.21
 */
public class OnsiteListTaskAdapter extends RecyclerView.Adapter<OnsiteListTaskAdapter.BaseViewHolder> {
    private List<HomeFunctionBean> mData;
    private Context context;

    public OnsiteListTaskAdapter(Context context) {
        this.context = context;
    }

    @Override
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_onsite_task_list, parent, false);
